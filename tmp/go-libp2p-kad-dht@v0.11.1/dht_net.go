...
func (dht *IpfsDHT) handleNewMessage(s network.Stream) bool {
	...
	for {
		...
		case pb.Message_PUT_VALUE:
			//fmt.Printf("@lry handle PutValue Req \n")
			break
		case pb.Message_GET_VALUE:
			//fmt.Printf("@lry handle GetValue Req \n")
			break
		case pb.Message_ADD_PROVIDER:
			//fmt.Printf("@lry handle AddProv Req \n")
			break
		case pb.Message_GET_PROVIDERS:
			//fmt.Printf("@lry handle GetProv Req \n")
			break
		case pb.Message_FIND_NODE:
			//fmt.Printf("@lry handle FindNode Req \n")
			break
		case pb.Message_PING:
			//fmt.Printf("@lry handle Ping Req \n")
			break
		default:
			//fmt.Printf("@lry handle BF Req \n")
			break
		}
		if handler == nil {
		...
		//fmt.Printf("@lry: handle succ and Respond \n")
...
func (dht *IpfsDHT) sendRequest(ctx context.Context, p peer.ID, pmes *pb.Message) (*pb.Message, error) {	
	...
	switch pmes.GetType() {
	case pb.Message_PUT_VALUE:
		//fmt.Printf("@lry send PutValue Req \n")
		break
	case pb.Message_GET_VALUE:
		//fmt.Printf("@lry send GetValue Req \n")
		break
	case pb.Message_ADD_PROVIDER:
		//fmt.Printf("@lry send AddProv Req \n")
		break
	case pb.Message_GET_PROVIDERS:
		//fmt.Printf("@lry send GetProv Req \n")
		break
	case pb.Message_FIND_NODE:
		//fmt.Printf("@lry send FindNode Req \n")
		break
	case pb.Message_PING:
		//fmt.Printf("@lry send Ping Req \n")
		break
	default:
		//fmt.Printf("@lry send BF Req \n")
		break
	}
...
func (dht *IpfsDHT) sendMessage(ctx context.Context, p peer.ID, pmes *pb.Message) error {
	...
	switch pmes.GetType() {
	case pb.Message_PUT_VALUE:
		//fmt.Printf("@lry send PutValue Msg \n")
		break
	case pb.Message_GET_VALUE:
		//fmt.Printf("@lry send GetValue Msg \n")
		break
	case pb.Message_ADD_PROVIDER:
		//fmt.Printf("@lry send AddProv Msg \n")
		break
	case pb.Message_GET_PROVIDERS:
		//fmt.Printf("@lry send GetProv Msg \n")
		break
	case pb.Message_FIND_NODE:
		//fmt.Printf("@lry send FindNode Msg \n")
		break
	case pb.Message_PING:
		//fmt.Printf("@lry send Ping Msg \n")
		break
	default:
		//fmt.Printf("@lry send BF Msg \n")
		break
	}
...
func (ms *messageSender) SendRequest(ctx context.Context, pmes *pb.Message) (*pb.Message, error) {
	// 禁了FindNode 不让自己完善路由表
	// if pmes.GetType() == pb.Message_FIND_NODE {
	// 	return nil, fmt.Errorf("findPeer is forbidden")
	// }
	// if pmes.GetType() == pb.Message_FIND_NODE {
	// 	fmt.Println("@lry test forbidden findPeer")
	// }	
	if err := ms.lk.Lock(ctx); err != nil {
		return nil, err
	}
